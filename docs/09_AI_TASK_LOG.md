...
Task: ? ?붾㈃ UI 3媛吏 ?덉씠?꾩썐 ?섏젙 ??applicants ?ㅻ뜑 ?듭씪, ? ?곸꽭 肄섑뀗痢?寃뱀묠 ?섏젙, ? 紐⑸줉 "? 李멸?" 踰꾪듉 ?쒓굅
Files Changed: src/app/(tabs)/team/[teamId]/_layout.tsx, src/app/(tabs)/team/[teamId]/applicants.tsx, src/app/(tabs)/team/index.tsx
Reason: (1) applicants ?붾㈃?먯꽌 ? ?ㅻ뜑/??컮媛 ?щ씪吏??臾몄젣 ?섏젙 ??TeamDetailTopHeader瑜??ㅻ뜑濡??ъ슜?섍퀬 ?붾㈃ ?대????몃씪???ㅻ줈媛湲???댄? 異붽?. (2) ? ?곸꽭 ???붾㈃?ㅼ쓽 肄섑뀗痢좉? ?곷떒 ?ㅻ뜑? 寃뱀튂??臾몄젣 ?섏젙 ??_layout.tsx?먯꽌 contentStyle.paddingTop???쇨큵 ?곸슜. (3) FAB怨?以묐났???ㅻ뜑 "? 李멸?" 踰꾪듉 ?쒓굅.
...
- 2026-03-17: ???꾨줈???먮룞 由щ뵒?됱뀡???쒓굅?섍퀬 踰꾪듉???⑤낫??吏꾩엯?쇰줈 蹂寃? role-onboarding???곸쓽 ?ъ씠利?諛??ъ씠利?肄ㅻ낫諛뺤뒪 異붽? 諛?臾몄옄??蹂듦뎄 ?묒뾽 吏꾪뻾.
...
- 2026-03-18 ?묒뾽: 踰좏듃??吏???곗씠???뚯뒪瑜?shared/regions/vietnam-regions.ts 怨듭슜 seed 紐⑤뱢濡??듯빀. ???듭뀡怨?Edge Function region validation???숈씪??province/district 肄붾뱶?뗭쓣 李몄“?섎룄濡??뺣━?섍퀬, 二쇱슂 ?꾩떆/??district coverage瑜?異붽? ?뺤옣.

- 2026-03-18 ?묒뾽: ?몃? 踰좏듃??吏??API瑜?runtime??吏곸젒 ?곌껐?섏? ?딄퀬, provider snapshot???대???媛?몄삤??scripts/sync-vietnam-regions.mjs 異붽?. shared/regions/vietnam-regions.provider.json ?앹꽦 寃쎈줈? 
pm run regions:sync ?ㅽ뻾 ?ㅽ겕由쏀듃 異붽?.
- 2026-03-18 ?묒뾽: Phase 2 ?⑤낫???덉젙?? `src/lib/onboarding.ts`瑜?異붽???怨듯넻 ?꾨줈????븷 ?⑤낫???꾨즺 ?곹깭瑜???怨녹뿉??怨꾩궛?섎룄濡??뺣━?덇퀬, `useProfile`??媛숈? 湲곗??쇰줈 `pendingRoleOnboarding`, `onboardingStep`, `nextOnboardingRoute`瑜??쒓났?섎룄濡??섏젙?덈떎. `phone-verify`, `create-profile`, `settings/*` ?붾㈃? ?먮룞 由щ뵒?됱뀡 ???踰꾪듉 湲곕컲 吏꾪뻾 ?먮쫫?쇰줈 諛붽엥??
- 2026-03-19 ?묒뾽: settings 硫붿씤 ?붾㈃??ScrollView 援ъ“濡??ш뎄?깊빐 紐⑤컮?쇱뿉???섎떒 移대뱶? 踰꾪듉源뚯? ?ㅽ겕濡?媛?ν븯?꾨줉 ?섏젙.
Date: 2026-03-20
AI Tool: Codex
...
[2026-03-23] user_consents ?곗꽑 援ы쁽 ?쒖옉.
- migration 014_add_user_consents_update_policy.sql 異붽?
- Edge Function record-consent 異붽?
- create-profile ?붾㈃???꾩닔 privacy / optional marketing consent ?곌껐
- Settings > Account ?붾㈃?먯꽌 consent ?곹깭 議고쉶/蹂寃??곌껐
- phone OTP ???꾩냽?쇰줈 ?좎?Date: 2026-03-23
AI Tool: Codex
...
- 2026-03-23: iPhone Vietnamese glyph rendering issue ??묒쓣 ?꾪빐 Times New Roman 湲곕컲 ?꾩뿭 ?고듃 ?곸슜. root layout, auth/onboarding/settings/tabs headers, tab labels, PrimaryButton, SelectField??怨듯넻 typography helper ?곌껐.
...
Reason: The profile dashboard still routed "? 李얘린" into a placeholder path, and many unfinished routes trapped the user without a working back action. Added a real public team search screen, pointed the team-find CTA to it, and rebuilt the shared placeholder component into a neutral coming-soon screen with back/home actions.
Date: 2026-03-25
AI Tool: Codex
...
- 2026-03-25: 홈 QuickActions占쏙옙 activeRole 占쏙옙占쏙옙占쏙옙占?占싻깍옙占싹곤옙 占쏙옙占쌀븝옙 占쏙옙占쏙옙 占쏙옙占싣?옙占?占쏙옙占쏙옙占쏙옙.

- 2026-03-25: HomeQuickActions 占싼깍옙 占쏙옙占쏙옙 占쏙옙占쏙옙占쌘듸옙 占싱쏙옙占쏙옙占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙占쏙옙 占쌔쏙옙트 占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙.

- 2026-03-25: 홈 占승븝옙占쏙옙 카占쏙옙 占쏙옙占쏙옙占쏙옙 activeRole 占쏙옙占?useOnboardingStatus 占쏙옙占쏙옙占쏙옙 占싻몌옙占싹곤옙, facility_manager占쏙옙 占승븝옙占쏙옙 카占쏙옙 占쏙옙占?占쏘동占쏙옙 占쏙옙占?CTA占쏙옙 占쏙옙占싱듸옙占쏙옙 占쏙옙占쏙옙占쏙옙.
- 2026-03-25: /(onboarding)/player, /(onboarding)/referee 占쏙옙화占쏙옙占쏙옙 占쌩곤옙占쏙옙 占쏙옙占쏙옙 占쏙옙構占?占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙寬占?placeholder占쏙옙 占쏙옙占쏙옙占쏙옙 占십곤옙 占쏙옙.
...
Date: 2026-03-26
AI Tool: Codex
Task: Implement the team members tab with owner-only member management actions
Files Changed: supabase/migrations/028_create_audit_logs_for_team_member_actions.sql, supabase/functions/update-team-member-role/index.ts, supabase/functions/kick-team-member/index.ts, supabase/config.toml, src/types/team.types.ts, src/services/team.service.ts, src/hooks/useTeamMembersQuery.ts, src/app/(team)/[teamId]/members.tsx, src/app/(team)/[teamId]/home.tsx, docs/09_AI_TASK_LOG.md, docs/10_CHANGELOG.md, docs/11_DEVELOPMENT_LOG.md
Reason: Replace the team members placeholder with a real roster screen grouped by role, add owner-only role-change and kick actions backed by Edge Functions, and persist an audit trail for team-member management.
Date: 2026-03-26
AI Tool: Codex
Task: Remove BOM from 028 audit-log migration after Supabase db push parser failure
Files Changed: supabase/migrations/028_create_audit_logs_for_team_member_actions.sql, docs/09_AI_TASK_LOG.md
Reason: Supabase db push failed at statement 0 with a parser error caused by a UTF-8 BOM at the start of the new 028 migration file.

- 2026-03-26: Reworked team members tab with grouped FlatList, direct role PATCH, owner kick flow, and migration 029.

- 2026-03-26: Updated auth login screen layout to remove top gap, move language selector to top-right pill + bottom sheet, rebalance CTA stack, and hide native login header.

- 2026-03-26: Replaced login screen localized strings with unicode-escaped literals to prevent garbled text in the auth hero UI.

- 2026-03-26: Reworked auth landing CTA order, added email-login/email-signup/faq routes, removed legacy signup placeholder, and updated login footer links.

- 2026-03-26: Replaced auth phone-verify placeholder with a real temporary screen that shows disabled phone verification UI and a development skip link to onboarding.

- 2026-03-26: Moved email login/signup back navigation from the top custom header to a link below the submit button for better tap access on devices.

- 2026-03-26: Fixed role drawer to load owned roles from account_types instead of rendering all roles by default for new users.

Date: 2026-03-26
AI Tool: Codex
Task: Hide duplicate onboarding native headers and replace the create-profile placeholder with a working common-profile screen
Files Changed: src/app/(onboarding)/_layout.tsx, src/app/(onboarding)/create-profile.tsx, docs/09_AI_TASK_LOG.md, docs/10_CHANGELOG.md, docs/11_DEVELOPMENT_LOG.md
Reason: The onboarding stack was still showing duplicate native headers and the create-profile route remained a placeholder, which blocked the post-auth onboarding flow.

- 2026-03-26: Added owner-only member management actions to the team home member list, including manager/captain role changes and kick flow entry from the ellipsis menu.
- 2026-03-26: Added migration 031 to harden direct team_members role updates with security definer helpers after owner role PATCH hit a team_members RLS violation.
- 2026-03-26: Re-saved migrations 030 and 031 as UTF-8 without BOM after Supabase db push failed at statement 0 on migration 030.
- 2026-03-26: Rebuilt migration 030 from scratch as UTF-8 without BOM after a false-positive byte trim corrupted the opening comment while troubleshooting the Supabase statement 0 parse error.

- 2026-03-26: ? ???꾪솚 ???댁쟾 ?붾㈃???좉퉸 蹂댁씠???꾩긽??以꾩씠湲??꾪빐 (tabs)/_layout.tsx?먯꽌 Tabs remount key瑜??쒓굅?섍퀬 detachInactiveScreens={false}, animation='none', lazy=false瑜??곸슜?덈떎.

- 2026-03-26: 肄섏넄??蹂댁씠??'Cannot record touch move without a touch start.' 寃쎄퀬瑜?以꾩씠湲??꾪빐 HomeBannerSlider ?먮룞 ?щ씪?대뱶瑜??ъ슜???곗튂 以묒뿉??硫덉텛?꾨줉 ?섏젙?섍퀬, 遺덊븘?뷀븳 auth ?붾쾭洹?濡쒓렇瑜??쒓굅?덈떎.

- 2026-03-26: 湲곗〈 ?꾨컮?瑜??ㅻⅨ ?ъ쭊?쇰줈 援먯껜????upload-avatar媛 怨좎젙 storage path瑜??ъ궗?⑺빐 'The resource already exists' ?ㅻ쪟媛 ?섎뜕 臾몄젣瑜??섏젙?덈떎. ???낅줈?쒕쭏??userId/profile-{timestamp}.{ext} 寃쎈줈瑜??ъ슜?섎룄濡?蹂寃?

- 2026-03-26: ?꾨컮? ?낅줈???뺤콉???ㅼ떆 議곗젙?덈떎. ???뚯씪??怨꾩냽 ?볦? ?딅룄濡?upload-avatar?먯꽌 湲곗〈 ?ъ슜???꾨컮? ?뚯씪??癒쇱? ??젣????怨좎젙 寃쎈줈 {userId}/profile.{ext}濡??ㅼ떆 ?낅줈?쒗븯?꾨줉 蹂寃?

## 2026-03-26 Bootstrap RPC + MMKV Cache
- Added migration 032_create_get_my_bootstrap_rpc.sql for get_my_bootstrap() RPC.
- Installed react-native-mmkv (^4.3.0) and added bootstrap MMKV cache utility with Expo Go-safe fallback.
- Added BootstrapData types/service/store/hook and root BootstrapInitializer gate.
- Switched getMyProfileBundle() to the single bootstrap RPC and removed drawer account_types direct query.
- Verified with cmd /c npx tsc --noEmit.


- 2026-03-26: Replaced the local-state useAuth hook with a shared Zustand auth store so email sign-in stops bouncing between the splash/index route and the login route during session bootstrap.
- 2026-03-26: Added pinned team announcement board support with migration 034, create-team-announcement/toggle-announcement-pin edge functions, sorted announcement queries, bulletin-board list rows, pinned detail toggle, and announcement create pin switch.
- 2026-03-26: Rebuilt the team detail stack shell around the shared TeamDetailTopHeader, restored clean Korean TEAM_SHELL copy, and replaced the placeholder team edit screen with a real react-hook-form + zod edit form backed by update-team.
- 2026-03-26: Trimmed the matches tab to bottom safe-area only so the shared team header remains the single top chrome for all team detail tabs.

## 2026-03-27 Team Tabs Rebuild
- Moved the team route group under src/app/(tabs)/team so team detail and all team sub-screens keep the bottom tab navigator.
- Converted the former src/app/(tabs)/team.tsx route to src/app/(tabs)/team/index.tsx.
- Updated all in-app route references from /(team)/... to /(tabs)/team/....
- Added a back button to the shared team detail header and kept team detail tab navigation inside the team tab stack.

- 2026-03-27: Implemented team recruitment management end-to-end with migration 035, update-team-recruitment-status/respond-team-recruitment-application edge functions, members-tab recruitment card, applicants screen, and team shell/header recruitment badge integration.
- 2026-03-27: Rebuilt the public team find screen to remove corrupted copy, align recruiting status labels with recruitment_status, and route into the tabbed team stack cleanly.
- 2026-03-27: Patched team/match service selects and i18n team-shell constants so recruitment_status-aware UI renders consistently across team search, team detail, and match-derived team references.
- 2026-03-27: Audited Codex/Claude team-detail history, removed the stale root (team) stack registration that caused Expo Router layout warnings, collapsed duplicated team-detail top spacing, and kept edit/applicants inside the shared team shell with inline back rows.
...
- 2026-03-27: Replaced the old per-tabs RoleSwitcherDrawer with a new GlobalDrawer, split drawer open state into drawer.store.ts, wired the drawer into the tab shell and team detail headers, and added inline language switching with immediate i18n updates and persisted selection.

- 2026-03-27: Repositioned drawer entry points so tab screens open GlobalDrawer from native headerLeft, removed inline home/team list hamburger buttons, and moved team detail role switching behind the shared ellipsis menu while removing all team-detail/subscreen hamburger controls.

- 2026-03-27: Completed team fee UI layer. Replaced fee tab placeholder with summary/segment panels, added fee settings screen, connected team detail stack route, and normalized team fee i18n keys for ko/vi/en.

Date: 2026-03-27
AI Tool: Codex
Task: Implement team match calendar, match creation, and match detail attendance flow inside tabbed team routes
Files Changed: supabase/migrations/038_create_matches.sql, supabase/functions/create-match/index.ts, supabase/functions/vote-attendance/index.ts, supabase/config.toml, src/types/match.types.ts, src/services/match.service.ts, src/hooks/useMatchQuery.ts, src/features/team-matches.copy.ts, src/features/team-matches/team-matches.helpers.ts, src/features/team-matches/components/TeamMatchInlineHeader.tsx, src/features/team-matches/components/TeamMatchCalendarStrip.tsx, src/features/team-matches/components/TeamMatchCard.tsx, src/app/(tabs)/team/[teamId]/matches.tsx, src/app/(tabs)/team/[teamId]/match-create.tsx, src/app/(tabs)/team/[teamId]/match/[matchId].tsx, src/app/(tabs)/team/[teamId]/_layout.tsx, src/types/home.types.ts, src/features/home/components/HomeNextMatch.tsx, docs/09_AI_TASK_LOG.md
Reason: Rebuild the team matches tab around server-created matches and attendance polls, add a calendar strip UI, provide a create flow and match detail voting flow, and keep everything inside the tabbed team shell.- 2026-03-27: Reworked the team matches experience from a horizontal date strip into a month-grid calendar, replaced the match cards with a scoreboard layout, and added tournament-aware copy/helpers/components.
- 2026-03-27: Extended the team match creation flow with a disabled league button, tournament creation mode, multi-team registration, and a new tournament bracket detail route under the tabbed team shell.- 2026-03-28: Rebuilt player profile editing flow. Added preferred position 1/2/3 selection, direct stat editing with optimistic updates, player profile copy helpers, and onboarding completion check based on position_first.

## 2026-03-28 Team Fee UX Completion
- Reworked the fee payment status tab with a monthly progress summary card, clearer unpaid/payment confirmation flow, and bulk selection for manager confirmation.
- Added the annual fee history screen under the tabbed team shell with yearly member rows, unpaid filtering, and per-member month confirmation.
- Re-ran TypeScript verification after wiring the fee-history route and updated fee i18n copy.
- 2026-03-28: Fixed the annual fee history infinite-update path, rebuilt the 12-month view into a fixed-name-column + horizontal month grid, and extended confirm-fee-payment so missing monthly fee records are created on demand before manager confirmation.

- 2026-03-28: Added team emblem editing to the team edit screen, wired update-team/update payloads to persist emblem_url, and normalized the affected team-shell locale keys while fixing previously broken TEAM_MATCHES locale syntax blocks.

- 2026-03-28: Implemented the mercenary recruitment slice end-to-end with migration 042, create/apply/respond/close Edge Functions, public search discovery, team-side mercenary management, applicant review, and profile application history preview/list.
...
- 2026-03-28: Implemented referee assignment Step 2. Added match roster submission/confirmation, referee accept-reject handling, referee payment recording, referee ratings, roster-submit route wiring, and completed the remaining referee/match TypeScript integration work.

- 2026-03-28: Fixed Supabase CLI config parsing failure by normalizing supabase/config.toml line endings and re-saving the file as UTF-8 without BOM.
