...
const COPY: Record<CopyKey, {
  ...
  ko: {
    title: "팀 찾기",
    subtitle: "공개 팀을 검색하고 상세 페이지로 이동할 수 있어요.",
    placeholder: "팀 이름으로 검색",
    emptyTitle: "조건에 맞는 팀이 없어요",
    emptyBody: "검색어를 바꾸거나 직접 새 팀을 만들어보세요.",
    createTeam: "팀 만들기",
    joinByCode: "초대코드로 가입",
    detail: "상세 보기",
    recruitingOpen: "모집중",
...
function getSportLabel(language: CopyKey, sportType: TeamRecord["sport_type"]): string {
  const map = {
    ko: { soccer: "축구", futsal: "풋살", both: "축구 · 풋살" },
          ...
          <View style={styles.tagRow}>
            ...
            <View style={styles.tagPill}>
              <Text style={styles.tagLabel}>
                {props.team.is_recruiting ? props.copy.recruitingOpen : props.copy.recruitingClosed}
              </Text>
            </View>
          </View>
        </View>
      ...
      >
        ...
        {query.isLoading ? (
          ...
          <View style={styles.centerState}>
            ...
            <View style={styles.emptyActions}>
              <Pressable style={styles.primaryButton} onPress={() => router.push("/(team)/create")}>
                <Text style={styles.primaryButtonLabel}>{copy.createTeam}</Text>
              </Pressable>
              <Pressable style={styles.secondaryButton} onPress={() => router.push("/(team)/join")}>
