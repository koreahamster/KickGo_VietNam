-- Ensure ranked preferred positions and editable player stats exist on player_profiles.
...
set
  ...
  preferred_position = coalesce(preferred_position, position_first),
...
alter table if exists public.player_profiles
  alter column stat_stamina set default 50,
  alter column stat_dribble set default 50,
  alter column stat_shooting set default 50,
  alter column stat_passing set default 50,
  alter column stat_defense set default 50,
  alter column stat_speed set default 50;
